...
!END DO
!
m1(0:mx(1),1:mx(2)) = Sqr((u(0:mx(1),1:mx(2))+u(1:mx(1)+1,1:mx(2)  ))/2.0_r8)
m2(1:mx(1),0:mx(2)) = Sqr((u(1:mx(1),0:mx(2))+u(1:mx(1)  ,1:mx(2)+1))/2.0_r8)
!
...
DO i = 1, mx(1)
  DO j = 1, mx(2)
!
    g1 = tmp*(u(i+1,j)-u(i-1,j))
    g2 = tmp*(u(i,j+1)-u(i,j-1))
    grad2(i,j) = g1*g1+g2*g2
!
  END DO
END DO
