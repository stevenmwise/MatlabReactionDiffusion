...
REAL(KIND=r8):: h2, residual
REAL(KIND=r8), DIMENSION(1:SIZE(u,1)-2  ,1:SIZE(u,2)-2):: s
!
mx(1) = SIZE(u,1)-2
mx(2) = SIZE(u,2)-2
!
...
!
CALL SearchDirection(r(1:mx(1),1:mx(2)),h)
!   
r(1:mx(1),1:mx(2)) = r(1:mx(1),1:mx(2))-SUM(r(1:mx(1),1:mx(2)))/(mx(1)*mx(2))
...
!
  residual = Norm2D(r)
!
  WRITE(*,1000) its, 'PSDResidual =', residual
  1000 FORMAT(I4,3X,A16,1X,ES17.9)
!
