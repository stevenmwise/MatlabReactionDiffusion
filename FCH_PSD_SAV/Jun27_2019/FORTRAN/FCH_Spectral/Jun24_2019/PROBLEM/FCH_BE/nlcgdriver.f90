...
REAL(KIND=r8):: energyvalue, dx1, dx2, h, h2, start, finish, mass
REAL(KIND=r8), DIMENSION(1:2):: p
REAL(KIND=r8), DIMENSION(:,:), ALLOCATABLE:: f, res, u, uo, uoo
!
...
ALLOCATE(  f(1:mx(1)  ,1:mx(2)  ),res(1:mx(1)  ,1:mx(2)  ), &
           u(0:mx(1)+1,0:mx(2)+1), uo(0:mx(1)+1,0:mx(2)+1), &
