%   This program calculate the FCH equation using Chen and Shen's first
%   order stabilization scheme.
%
...
%
[derivx,derivy,lap] = init_operators(N,ratio,index);
%
...
%
    if (mod(k,steps_per_screen_plot) == 0)
        ...
        colorbar;
        title(['FCH-ChenShen: dt = ',num2str(dt),'  time = ',num2str(time)]);
        getframe;
    end
%
